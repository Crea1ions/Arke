...
SLASH_COMMANDS: dict[str, str] = {
    ...
    "/dialogue-actif":     "Active/désactive le Dialogue actif (/dialogue-actif on|off) — persistant",
    "/suspendre-dialogue": "Pause temporairement le Dialogue actif (/suspendre-dialogue [heures])",
    "/reprendre-dialogue": "Réactive le Dialogue actif après pause temporaire",
    "/initiative":         "Alias legacy de /dialogue-actif",
    "/pause-initiatives":  "Alias legacy de /suspendre-dialogue",
    "/resume-initiatives": "Alias legacy de /reprendre-dialogue",
